            ...
            <div className="login-section">
                {stage === 'login' && (
                    <form className="login-form" onSubmit={handleLoginSubmit}>
                        ...
                        <div className='buttons-log-form'>
                            ...
                            <Link to={"/RegistrationPage"}><button className="Login-button" data="Register Now!"></button></Link>
                            <button type="button" onClick={() => setStage('forgotPassword')} className="Login-button">Forgot Password?</button>
                        </div>
                    </form>
                )}
                ...
                {stage === 'forgotPassword' && (
                    <div className="forgot-password-section">
                        ...
                        <div className='buttons-log-form'>
                            <button onClick={handleForgotPassword} className="Login-button">Send Reset Code</button>
                            <button onClick={() => setStage('login')} className="Login-button">Back to Login</button>
                        </div>
                    </div>
                )}
